    ...
    if message.chat.type == 'private':
        if message.text == '🎲 Рандомное число':
            ...
            bot.send_message(message.chat.id,
                             ...
                             '<u>Я умею:</u>\n'
                             '- Выдавать рандомное число по нажатию кнопки.\n'
                             '- Спрашивать как дела и отвечать.\n'
                             '- Выводить стоимость BTC на текущий момент времени.\n'
                             '- Запрашивать предоставление номера телефона пользователя.'.
