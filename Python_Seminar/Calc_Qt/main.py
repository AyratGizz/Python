...
class Calculator(QMainWindow):
    def __int__(self):
        ...
        self.ui.btn_clear.connect(self.clear_all)
        self.ui.btn_ce.connect(self.clear_entry)
        self.ui.btn_point.connect(self.add_point)

        self.ui.btn_ravno.clicked.connect(self.calculate)
        self.ui.btn_plus.clicked.connect(lambda: self.add_temp('+'))
        self.ui.btn_minus.connect(lambda: self.math_operation('-'))
        self.ui.btn_umnoshenie.connect(lambda: self.math_operation('×'))
        self.ui.btn_delenie.connect(lambda: self.math_operation('÷'))
